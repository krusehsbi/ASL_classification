...
from tensorflow.keras.layers import Conv2D, AveragePooling2D, Flatten, Dense, Dropout, Input, BatchNormalization


class CustomCNN_v4(tf.keras.Model):
    def __init__(self, img_shape):
        super(CustomCNN_v4, self).__init__()
